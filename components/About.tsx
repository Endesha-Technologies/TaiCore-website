          ...
          <AnimateOnScroll direction="left">
            <div className="space-y-6">
              <p className="text-lg text-gray-600 leading-relaxed">
                TaiCore Digital Services is a technology company focused on helping businesses build, launch, and scale modern digital solutions. We work with startups, entrepreneurs, and growing organizations to transform ideas into reliable software products that deliver real value.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Whether it&apos;s building a new platform, modernizing an existing system, or integrating advanced technologies, TaiCore Digital Services partners with clients to turn ideas into powerful digital products.
              </p>
            </div>
          </AnimateOnScroll>
